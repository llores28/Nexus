---
name: prereqs-check
description: Check and guide setup for prerequisites (Docker, extensions, IDE Docker Extension, Python, Git, Node)
---
# Prerequisites Check

## Trigger
- First run of any workflow that needs Docker, scraping, or external tools
- Use before local environment, full smoketest, or scraping work when prerequisites are uncertain.
- User runs `/prereqs`
...
- IDE Docker Extension requires manual install via Extensions panel — tool provides steps
