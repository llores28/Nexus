...
```
nexus journal diff --project-dir . --format human
```
...
```
nexus journal next add "<task>"
nexus journal blocker add "<text>"
```

## Step 4 — Export dashboard
```
nexus journal export --project-dir . --format human
```
