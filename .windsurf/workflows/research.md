...
// turbo
```
python nexus/cli/bs_cli.py research docs "<query>" --format json
```

## 2) Research a specific package
```
python nexus/cli/bs_cli.py research deps <package-name> --format json
```

## 3) Check recent changes / changelog
```
python nexus/cli/bs_cli.py research changelog <package-name> --format json
```

## 4) Compare two packages
```
python nexus/cli/bs_cli.py research compare <pkg-a> <pkg-b> --format json
```
